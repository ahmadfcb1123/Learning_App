  ...
  const uploadProduct = async () => {
    ...
    for (let i = 0; i < sentence.length; i++) {
      for (let j = 0; j < sentence[i].length; j++) {
        formData.append(`sentences[${i}][]`, sentence[i][j]);
        formData.append(`answers[${i}][]`, sentenceAnswer[i][j]);
      }
    }
    formData.append('skillData','s55');
      ...
      <div className="container" style={{ marginLeft:"280px"}}>
        <div className="row">
          <div className="col-md-8 mt-4">
            <h5 className="mb-4">Add Grammar Reorder Question</h5>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="mb-3 row">
                <label className="col-sm-3">Answer</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
